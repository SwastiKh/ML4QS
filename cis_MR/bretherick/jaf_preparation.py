...
OUTPUT_PATH =os.path.join(HOME,'cis_MR', 'bretherick', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR', 'bretherick', 'bretherick_pqtl_mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR', 'bretherick', 'jaf.txt'), sep='\t', header=True, index=False)
