...
OUTPUT_PATH =os.path.join(HOME,'cis_MR', 'gudjonsson', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR', 'gudjonsson', 'gudjonsson_pqtl_mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR', 'gudjonsson', 'jaf.txt'), sep='\t', header=True, index=False)
