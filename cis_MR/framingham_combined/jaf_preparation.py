...
OUTPUT_PATH =os.path.join(HOME,'cis_MR', 'framingham_combined', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR', 'framingham_combined', 'framingham_mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR', 'framingham_combined', 'jaf.txt'), sep='\t', header=True, index=False)
