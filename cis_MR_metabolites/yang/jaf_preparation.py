...
OUTPUT_PATH =os.path.join(HOME,'cis_MR_metabolites', 'yang', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR_metabolites', 'yang', 'yang_plasma_pqtl_mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR_metabolites', 'yang', 'jaf.txt'), sep='\t', header=True, index=False)
