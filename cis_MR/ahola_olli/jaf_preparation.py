...
OUTPUT_PATH =os.path.join(HOME,'cis_MR', 'ahola_olli', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR', 'ahola_olli', 'ahola_olli__mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR', 'ahola_olli', 'jaf.txt'), sep='\t', header=True, index=False)
