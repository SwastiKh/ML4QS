...
OUTPUT_PATH =os.path.join(HOME,'cis_MR', 'scallop', 'results')
...
# exposure index
# exposure index
generic_jaf['exposure_path'] = os.path.join(HOME, 'cis_MR', 'scallop', 'scallop_mapper.tsv')
...
###############################################################################
jaf.to_csv(os.path.join(HOME,'cis_MR', 'scallop', 'jaf.txt'), sep='\t', header=True, index=False)
